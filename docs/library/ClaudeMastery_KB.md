# Knowledge Base: https://thedecipherist.github.io/claude-code-mastery/



--- SOURCE: https://thedecipherist.github.io/claude-code-mastery/ ---

* [![TheDecipherist](thedecipherist.png)](https://thedecipherist.com?utm_source=github&utm_medium=website&utm_campaign=claude-code-mastery&utm_content=header-logo "By TheDecipherist")

  Claude Code Mastery
  by [TheDecipherist](https://thedecipherist.com?utm_source=github&utm_medium=website&utm_campaign=claude-code-mastery&utm_content=header-author)

* [GitHub Code](https://github.com/TheDecipherist/claude-code-mastery)
* [![TheDecipherist](thedecipherist.webp "Visit TheDecipherist")](https://thedecipherist.com?utm_source=github&utm_medium=website&utm_campaign=claude-code-mastery&utm_content=header-nav)
...
[🎉 Updated Based on Community Feedback](#updated-based-on-community-feedback)[Part 1: The Global CLAUDE.md as Security Gatekeeper](#part-1-the-global-claudemd-as-security-gatekeeper)[The Memory Hierarchy](#the-memory-hierarchy)[What Belongs in Global](#what-belongs-in-global)[Why This Matters: Claude Reads Your .env](#why-this-matters-claude-reads-your-env)[Defense in Depth](#defense-in-depth)[Team Workflows: Evolving CLAUDE.md](#team-workflows-evolving-claudemd)[Part 2: Global Rules for New Project Scaffolding](#part-2-global-rules-for-new-project-scaffolding)[The Problem Without Scaffolding Rules](#the-problem-without-scaffolding-rules)[The Solution: Scaffolding Rules in Global CLAUDE.md](#the-solution-scaffolding-rules-in-global-claudemd)[5. Required CLAUDE.md Sections](#5-required-claudemd-sections)[Quality Gates in Scaffolding](#quality-gates-in-scaffolding)[Example: What Happens When You Create a Project](#example-what-happens-when-you-create-a-project)[Part 3: MCP Servers — Claude's Integrations](#part-3-mcp-servers-claude39s-integrations)[What MCP Servers Do](#what-mcp-servers-do)[Adding MCP Servers](#adding-mcp-servers)[Essential MCP Servers](#essential-mcp-servers)[Browser Automation: Choosing the Right MCP](#browser-automation-choosing-the-right-mcp)[MCP in CLAUDE.md](#mcp-in-claudemd)[Part 4: Context7 — Live Documentation](#part-4-context7-live-documentation)[The Problem](#the-problem)[The Solution](#the-solution)[Installation](#installation)[Usage Patterns](#usage-patterns)[Add to Global CLAUDE.md](#add-to-global-claudemd)[Part 5: Custom Commands and Sub-Agents](#part-5-custom-commands-and-sub-agents)[Creating Commands](#creating-commands)[Benefits of Commands](#benefits-of-commands)[Sub-Agents](#sub-agents)[Global Commands Library](#global-commands-library)[Part 6: Why Single-Purpose Chats Are Critical](#part-6-why-single-purpose-chats-are-critical)[The Research](#the-research)[Why This Happens](#why-this-happens)[What Happens When You Mix Topics](#what-happens-when-you-mix-topics)[The Golden Rule](#the-golden-rule)[Practical Guidelines](#practical-guidelines)[Use /clear Liberally](#use-clear-liberally)[Sub-Agents for Topic Isolation](#sub-agents-for-topic-isolation)[Part 7: Skills & Hooks — Enforcement Over Suggestion](#part-7-skills-amp-hooks-enforcement-over-suggestion)[Why CLAUDE.md Rules Can Fail](#why-claudemd-rules-can-fail)[The Critical Difference](#the-critical-difference)[Hooks: Deterministic Control](#hooks-deterministic-control)[Skills: Packaged Expertise](#skills-packaged-expertise)[Combining Hooks and Skills](#combining-hooks-and-skills)[Updated Defense in Depth](#updated-defense-in-depth)[Putting It All Together](#putting-it-all-together)[The Complete Global CLAUDE.md Template](#the-complete-global-claudemd-template)[Quick Reference](#quick-reference)[GitHub Repo](#github-repo)[Sources](#sources)
...
By [TheDecipherist](https://thedecipherist.com?utm_source=github&utm_medium=website&utm_campaign=claude-code-mastery&utm_content=footer-author)
·
[View Source](https://github.com/TheDecipherist/claude-code-mastery)
